...
let MinpubController = class MinpubController {
    ...
    async createMinpub(minpubDTO) {
        return await this.minpubService.createMinpub(minpubDTO);
    }
    async updateMinpub(minpubDTO, id) {
        return await this.minpubService.updateMinpub(minpubDTO, id);
    }
    async deleteMinpub(id) {
        return await this.minpubService.deleteMinpub(parseInt(`${id}`));
    }
};
__decorate([
    (0, swagger_1.ApiResponse)({
        status: 200,
        type: [minpub_dto_1.MinpubDTO]
    }),
    (0, common_1.Get)(),
...
], MinpubController.prototype, "getAllMinpub", null);
__decorate([
    (0, swagger_1.ApiResponse)({
        status: 200,
        type: minpub_dto_1.MinpubDTO
    ...
    (0, swagger_1.ApiParam)({
        name: 'id',
        description: 'Identificador de minpub'
    }),
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [minpub_dto_1.MinpubDTO, Number]),
    __metadata("design:returntype", Promise)
